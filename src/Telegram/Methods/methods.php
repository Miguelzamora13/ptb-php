...
namespace DevDasher\PTB_PHP\Telegram\Methods;

use CURLFile;

use function DevDasher\PTB_PHP\Config\prepareAndSendApiRequest;
...
function getMe(): array {
    return prepareAndSendApiRequest(__FUNCTION__);
}
 ...
 */
function exportChatInviteLink(null|int|string $chat_id = null): array {
    return prepareAndSendApiRequest(__FUNCTION__, get_defined_vars());
}
